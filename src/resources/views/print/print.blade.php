...
<script src="{{ asset('jsprint/scripts/JSPrintManager.js') }}"></script>
...
<script>
    ...
    //Do printing...
    var printUrl = "{{ route('print.raw') }}"; //memanggil laravel route name
    function print(o) {
        if (jspmWSStatus()) {
            var xhr = new XMLHttpRequest();
            xhr.open('GET', printUrl, true); // pakai route name Laravel
